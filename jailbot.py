...
async def awp(ctx):  
    ...
    emb.add_field(name='**Name**', value=a5.server_name, inline=True)
    emb.add_field(name='Map', value=a5.curr_map, inline=True)
    emb.add_field(name='Players', value=a5.players, inline=True)
    emb.add_field(name='\u200b', value=a5.connect_link, inline=False)
